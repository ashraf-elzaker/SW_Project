...
const fallbackImage =
  ...
  encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600">
      <rect width="600" height="600" fill="#f3efe8"/>
      <rect x="120" y="140" width="360" height="250" rx="24" fill="#ffffff"/>
      <rect x="200" y="235" width="200" height="100" rx="30" fill="#b8aa97"/>
    ...
    <div className="main-area">
      ...
      <div className="card" style={{padding:20}}>
        <div style={{display:'flex', gap:16}}>
          <div>
            <img src={order.product_info?.image || fallbackImage} alt={order.product_info?.name} style={{width:220, height:220, objectFit:'cover', borderRadius:8}} />
          </div>
          <div>
