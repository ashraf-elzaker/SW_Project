...
const productCategories = [
  ...
  { id: 'fashion', name: 'Fashion', color: colors.primary[600], bg: colors.beige[100], icon: '', gradient: 'from-brown-500 to-amber-500' },
  { id: 'home', name: 'Home & Living', color: colors.warning[500], bg: colors.warning[100], icon: '', gradient: 'from-amber-500 to-orange-500' },
  { id: 'beauty', name: 'Beauty', color: colors.primary[500], bg: colors.beige[200], icon: '', gradient: 'from-brown-500 to-amber-500' },
  { id: 'sports', name: 'Sports', color: colors.success[500], bg: colors.success[100], icon: '', gradient: 'from-green-500 to-emerald-500' },
  { id: 'books', name: 'Books', color: colors.primary[600], bg: colors.beige[100], icon: '', gradient: 'from-brown-500 to-amber-500' },
];
...
const styles = `
  ...
  * {
  ...
  .shape-5 {
    ...
    bottom: 30%;
    right: 20%;
    background: radial-gradient(circle, ${colors.primary[300]}15 0%, transparent 70%);
